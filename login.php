...
<head>
    ...
    define('bankName', 'Equity Bank',true);
...
<h1 class="alert alert-success rounded-0"><?php echo bankName; ?><small class="float-right text-muted" style="font-size: 12pt;"><kbd>Presented by:Hendrix Ombonyo</kbd></small></h1>
<br>
<?php echo $error ?>
<br>
